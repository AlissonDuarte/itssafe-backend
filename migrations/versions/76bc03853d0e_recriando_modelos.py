...
Revision ID: 76bc03853d0e
Revises: 
Create Date: 2025-04-08 00:01:11.443544
...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('THEFT', 'STRANGE_MOVIMENT', 'FIGHT', 'PERSON_AGGRESSIVE', 'DRUGS', name='occurrencetype'), nullable=False),
    sa.Column('coordinates', sa.JSON(), nullable=False),
    sa.Column('local', geoalchemy2.types.Geometry(geometry_type='POINT', srid=4326, from_text='ST_GeomFromEWKT', name='geometry'), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    #op.create_index('idx_occurrences_local', 'occurrences', ['local'], unique=False, postgresql_using='gist')
    op.create_index(op.f('ix_occurrences_id'), 'occurrences', ['id'], unique=False)
    op.create_index(op.f('ix_occurrences_uuid'), 'occurrences', ['uuid'], unique=True)
    ...
    sa.Column('phone_identifier', sa.String(), nullable=True),
    ...
    op.create_table('user_occurrences',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('uuid', sa.UUID(), nullable=True),
    ...
    op.create_index(op.f('ix_user_occurrences_id'), 'user_occurrences', ['id'], unique=False)
    op.create_index(op.f('ix_user_occurrences_uuid'), 'user_occurrences', ['uuid'], unique=True)
...
def downgrade() -> None:
    ...
    # op.create_index('countysub_lookup_name_idx', 'countysub_lookup', [sa.literal_column('soundex(name::text)')], unique=False)
    ...
    # op.create_index('place_lookup_name_idx', 'place_lookup', [sa.literal_column('soundex(name::text)')], unique=False)
    ...
    # op.create_index('idx_tiger_featnames_snd_name', 'featnames', [sa.literal_column('soundex(name::text)')], unique=False)
    # op.create_index('idx_tiger_featnames_lname', 'featnames', [sa.literal_column('lower(name::text)')], unique=False)
    ...
    # op.create_index('county_lookup_name_idx', 'county_lookup', [sa.literal_column('soundex(name::text)')], unique=False)
    ...
    # )
    # op.drop_index(op.f('ix_user_occurrences_uuid'), table_name='user_occurrences')
    # op.drop_index(op.f('ix_user_occurrences_id'), table_name='user_occurrences')
    # op.drop_table('user_occurrences')
    # op.drop_index(op.f('ix_users_uuid'), table_name='users')
    # op.drop_index(op.f('ix_users_username'), table_name='users')
    # op.drop_index(op.f('ix_users_id'), table_name='users')
    # op.drop_index(op.f('ix_users_email'), table_name='users')
    # op.drop_table('users')
    # op.drop_index(op.f('ix_occurrences_uuid'), table_name='occurrences')
    # op.drop_index(op.f('ix_occurrences_id'), table_name='occurrences')
    # op.drop_index('idx_occurrences_local', table_name='occurrences', postgresql_using='gist')
